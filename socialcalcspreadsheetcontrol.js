...
' &nbsp;<img src="%img.divider1.png" style="vertical-align:bottom;">&nbsp; '+
//'<img id="%id.button_movefrom" src="%img.movefromoff.png" style="vertical-align:bottom;">'+
//' <img id="%id.button_movepaste" src="%img.movepasteoff.png" style="vertical-align:bottom;">'+
//' <img id="%id.button_moveinsert" src="%img.moveinsertoff.png" style="vertical-align:bottom;">'+
//' &nbsp;<img src="%img.divider1.png" style="vertical-align:bottom;">&nbsp; '+
