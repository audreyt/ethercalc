...
SocialCalc.DetermineValueType = function(rawvalue) {
   ...
   if (value.length==0) {
      ...
      value = ((navigator.language).indexOf("fr") > -1)  ? (SocialCalc.FormatNumber.convert_date_gregorian_to_julian(year, matches[2]-0, matches[1]-0)-2415019) : (SocialCalc.FormatNumber.convert_date_gregorian_to_julian(year, matches[1]-0, matches[2]-0)-2415019);
      type = "nd";
      }
