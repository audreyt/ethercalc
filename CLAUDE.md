...
| 2026-06-12 | selfhost | **SH-2 optional in-Worker rate limit + README proxy mandate.** `ETHERCALC_RATELIMIT` token bucket (`src/lib/rate-limit.ts`, default off); README/docs require `docker-compose.proxy.yml` for internet-facing self-host; plain compose documented as LAN/dev only. CLAUDE.md §13 Q7/Q11 updated. | (this commit) |
